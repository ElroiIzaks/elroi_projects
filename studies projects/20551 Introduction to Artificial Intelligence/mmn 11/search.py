...
def depthFirstSearch(problem):
    ...
    path = []
    explored = []
    frontier.push((problem.getStartState(),path,0))
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    path = []
    explored = []
    frontier.push((problem.getStartState(),path),heuristic(problem.getStartState(),problem))
    while not frontier.isEmpty():
        curr,path = frontier.pop()
        ...
        for successor in problem.getSuccessors(curr):
            ...
            childPath = path+[successor[1]]
            childCost = problem.getCostOfActions(childPath)
            frontier.push((child, childPath), childCost + heuristic(child,problem))
    return []
